...
public:
	void installAction(QObject * act) {
		...
		if (setup == false) {
			connect(signalMapper, SIGNAL(mapped(QObject*)), this, SLOT(ActionTriggered(QObject*)));
			setup = true;
		}

	}
	void installTreeAction(QObject * act) {
		connect(act, SIGNAL(itemPressed(QTreeWidgetItem*, int)), this, SLOT(tritemPressed(QTreeWidgetItem*, int)));
		connect(act, SIGNAL(itemClicked(QTreeWidgetItem*, int)), this, SLOT(tritemClicked(QTreeWidgetItem*, int)));
		connect(act, SIGNAL(itemDoubleClicked(QTreeWidgetItem*, int)), this, SLOT(tritemDoubleClicked(QTreeWidgetItem*, int)));
		connect(act, SIGNAL(itemActivated(QTreeWidgetItem*, int)), this, SLOT(tritemActivated(QTreeWidgetItem*, int)));
		connect(act, SIGNAL(itemEntered(QTreeWidgetItem*, int)), this, SLOT(tritemEntered(QTreeWidgetItem*, int)));
		connect(act, SIGNAL(itemChanged(QTreeWidgetItem*, int)), this, SLOT(tritemChanged(QTreeWidgetItem*, int)));
		connect(act, SIGNAL(itemExpanded(QTreeWidgetItem*)), this, SLOT(tritemExpanded(QTreeWidgetItem*)));
		connect(act, SIGNAL(itemCollapsed(QTreeWidgetItem*)), this, SLOT(tritemCollapsed(QTreeWidgetItem*)));
		connect(act, SIGNAL(currentItemChanged(QTreeWidgetItem*, QTreeWidgetItem*)), this, SLOT(trcurrentItemChanged(QTreeWidgetItem*, QTreeWidgetItem*)));
		connect(act, SIGNAL(itemSelectionChanged()), this, SLOT(tritemSelectionChanged()));
	}
	...
	void installEditAction(QObject * edit) {
		connect(edit, SIGNAL(textChanged(const QString &)), this, SLOT(etextChanged(const QString &)));
		connect(edit, SIGNAL(textEdited(const QString &)), this, SLOT(etextEdited(const QString &)));
		connect(edit, SIGNAL(cursorPositionChanged(int, int)), this, SLOT(ecursorPositionChanged(int, int)));
		connect(edit, SIGNAL(returnPressed()), this, SLOT(ereturnPressed()));
		connect(edit, SIGNAL(editingFinished()), this, SLOT(eeditingFinished()));
		connect(edit, SIGNAL(selectionChanged()), this, SLOT(eselectionChanged()));
	}

	void installDialogAction(QDialog * dlg) {
		connect(dlg, SIGNAL(finished(int)), this, SLOT(onFinish(int)));
		connect(dlg, SIGNAL(accepted()), this, SLOT(onAccept()));
		connect(dlg, SIGNAL(rejected()), this, SLOT(onReject()));
	}

	void installSciAction(QsciScintilla * sci) {
		connect(sci, SIGNAL(QSCN_SELCHANGED(bool)), this, SLOT(QSCN_SELCHANGED(bool)));
		connect(sci, SIGNAL(SCN_AUTOCCANCELLED()), this, SLOT(SCN_AUTOCCANCELLED()));
		connect(sci, SIGNAL(SCN_AUTOCCHARDELETED()), this, SLOT(SCN_AUTOCCHARDELETED()));
		connect(sci, SIGNAL(SCN_AUTOCCOMPLETED(const char *, int , int , int )), this, SLOT(SCN_AUTOCCOMPLETED(const char *, int, int, int)));
		connect(sci, SIGNAL(SCN_AUTOCSELECTION(const char *, int , int , int )), this, SLOT(SCN_AUTOCSELECTION(const char *, int, int, int)));
		connect(sci, SIGNAL(SCN_AUTOCSELECTION(const char *, int )), this, SLOT(SCN_AUTOCSELECTION(const char *, int)));
		connect(sci, SIGNAL(SCEN_CHANGE()), this, SLOT(SCEN_CHANGE()));
		connect(sci, SIGNAL(SCN_CALLTIPCLICK(int)), this, SLOT(SCN_CALLTIPCLICK(int)));
		connect(sci, SIGNAL(SCN_CHARADDED(int)), this, SLOT(SCN_CHARADDED(int)));
		connect(sci, SIGNAL(SCN_DOUBLECLICK(int , int , int )), this, SLOT(SCN_DOUBLECLICK(int, int, int)));
		connect(sci, SIGNAL(SCN_DWELLEND(int, int, int)), this, SLOT(SCN_DWELLEND(int, int, int)));
		connect(sci, SIGNAL(SCN_DWELLSTART(int, int, int)), this, SLOT(SCN_DWELLSTART(int, int, int)));
		connect(sci, SIGNAL(SCN_FOCUSIN()), this, SLOT(SCN_FOCUSIN()));
		connect(sci, SIGNAL(SCN_FOCUSOUT()), this, SLOT(SCN_FOCUSOUT()));
		connect(sci, SIGNAL(SCN_HOTSPOTCLICK(int, int)), this, SLOT(SCN_HOTSPOTCLICK(int, int)));
		connect(sci, SIGNAL(SCN_HOTSPOTDOUBLECLICK(int, int)), this, SLOT(SCN_HOTSPOTDOUBLECLICK(int, int)));
		connect(sci, SIGNAL(SCN_HOTSPOTRELEASECLICK(int , int )), this, SLOT(SCN_HOTSPOTRELEASECLICK(int, int)));
		connect(sci, SIGNAL(SCN_INDICATORCLICK(int , int )), this, SLOT(SCN_INDICATORCLICK(int, int)));
		connect(sci, SIGNAL(SCN_INDICATORRELEASE(int , int )), this, SLOT(SCN_INDICATORRELEASE(int, int)));
		connect(sci, SIGNAL(SCN_MACRORECORD(unsigned int, unsigned long, void *)), this, SLOT(SCN_MACRORECORD(unsigned int, unsigned long, void *)));
		connect(sci, SIGNAL(SCN_MARGINCLICK(int , int , int )), this, SLOT(SCN_MARGINCLICK(int, int, int)));
		connect(sci, SIGNAL(SCN_MARGINRIGHTCLICK(int , int , int )), this, SLOT(SCN_MARGINRIGHTCLICK(int, int, int)));
		connect(sci, SIGNAL(SCN_MODIFIED(int, int, const char *, int, int, int, int, int, int, int)), this, SLOT(SCN_MODIFIED(int, int, const char *, int, int, int, int, int, int, int)));
		connect(sci, SIGNAL(SCN_MODIFYATTEMPTRO()), this, SLOT(SCN_MODIFYATTEMPTRO()));
		connect(sci, SIGNAL(SCN_NEEDSHOWN(int, int)), this, SLOT(SCN_NEEDSHOWN(int, int)));
		connect(sci, SIGNAL(SCN_PAINTED()), this, SLOT(SCN_PAINTED()));
		connect(sci, SIGNAL(SCN_SAVEPOINTLEFT()), this, SLOT(SCN_SAVEPOINTLEFT()));
		connect(sci, SIGNAL(SCN_SAVEPOINTREACHED()), this, SLOT(SCN_SAVEPOINTREACHED()));
		connect(sci, SIGNAL(SCN_STYLENEEDED(int)), this, SLOT(SCN_STYLENEEDED(int)));
		connect(sci, SIGNAL(SCN_UPDATEUI(int)), this, SLOT(SCN_UPDATEUI(int)));		//!
		connect(sci, SIGNAL(SCN_USERLISTSELECTION(const char *, int, int, int)), this, SLOT(SCN_USERLISTSELECTION(const char *, int, int, int)));
		connect(sci, SIGNAL(SCN_USERLISTSELECTION(const char *, int)), this, SLOT(SCN_USERLISTSELECTION(const char *, int)));
		connect(sci, SIGNAL(SCN_ZOOM()), this, SLOT(SCN_ZOOM()));
	}
};
